export const API_ROUTES = {
  ...
  authEntraStart: '/api/auth/entra/start',
  authEntraCallback: '/api/auth/entra/callback',
  ...
  authPasswordChangeConfirm: '/api/auth/password-change/confirm',
  ...
  authEntraSettings: '/api/settings/entra',
